...
Text sampling
```{r}
# Created manually from text by Kenneth as "/Users/emiltrencknerjessen/Desktop/priv/DANSK_eval/output/Thesis/DANSK_initial/sampling.csv"
```
Kappa initial
```{r}
...
write.csv(kappa, "/Users/emiltrencknerjessen/Desktop/priv/DANSK_eval/output/Thesis/DANSK_initial/kappa_initial.csv")
```
...
write.csv(kappa, "/Users/emiltrencknerjessen/Desktop/priv/DANSK_eval/output/Thesis/DANSK/kappa_streamlined_dansk.csv")
```
Kappa DANSK and initial
```{r}
...
write.csv(kappa, "/Users/emiltrencknerjessen/Desktop/priv/DANSK_eval/output/Thesis/DANSK/kappa_initial_dansk.csv")
```
Doc overlap
```{r}
