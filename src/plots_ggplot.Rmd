...
- output/DANSK_final_interrater/conf_matrix.csv
- output/ner_models_performance/small_confusion_matrix.csv
- output/ner_models_performance/medium_confusion_matrix.csv
- output/ner_models_performance/large_confusion_matrix.csv
...
- output/other_models_performance/tag_f1_score.csv # MAYBE OTHER NAME OF CSV?
  - Y-Axis F1-score, X-axis each model grouped by tag
  
- output/ner_models_performance/tag_f1_score.csv # MAYBE OTHER NAME OF CSV?
  - Y-Axis F1-score, X-axis each model grouped by tag
